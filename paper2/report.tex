...
\begin{figure}
	\includegraphics[width=1.0\columnwidth]{images/Arduino-settings.jpg}\label{F:arduino}
	\caption{Arduino IDE configuration setup}
\end{figure}
...
\begin{figure}[htb]
	\includegraphics[width=1.0\columnwidth]{images/Top-view.jpg}\label{F:topview}
	\caption{Top View of Robot Car}
%\end{figure}

%\begin{figure}
	\includegraphics[width=1.0\columnwidth]{images/Side-view2.jpg}\label{F:sideview}
	\caption{Side view of Robot Car}
%\end{figure}

%\begin{figure}
	\includegraphics[width=1.0\columnwidth]{images/Front-view.jpg}\label{F:frontview}
