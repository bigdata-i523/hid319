...
\begin{figure}
	\includegraphics[width=1.0\columnwidth]{paper2/images/L298N_Hbridge.jpg}
...
\begin{figure}
	\includegraphics[width=1.0\columnwidth]{paper2/images/Arduino-settings.jpg}
	\caption{L298N Dual H-bridge Stepper Motor}
\end{figure}

\section{Code}
Code for Obstacle Avoidance Robot car is placed in ``Code`` directory. Copy this code to Arduino IDE which is installed on Raspberry Pi.
