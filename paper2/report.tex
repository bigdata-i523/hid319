...
longer in distance. The diagram in Figure \ref{F:sg90} shows .... .
...
\item Connect ENA to GPIO0 of ESP8266 NodeMCU
\item Connect ENB to GPIO2
\item Connect IN1 to GPIO12
\item Connect IN2 to GPIO14
\item Connect IN3 to GPIO15
\item Connect IN4 to GPIO13
\end{itemize}
...
\VerbatimInput{code/Robot_Obstacle_Avoidance.py}
